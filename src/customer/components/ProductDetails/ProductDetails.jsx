...
{/* Product Images */}
        <section className=" grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              ...
              <h1 className=" text-lg lg:text-lg text-gray-900 opacity-60 pb-1">
                {" "}
                Casual Puff Sleeves Soild Women White Top
              </h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className=" flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">5632 Ratings</p>
                ...
                <Box className=" mt-5 space-y-3"> 
                  ...
                  <Grid container alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress 
                      sx={{bgcolor:"#d0d0d0",borderRadius:4,height:6}}
                      variant="determinate" value={35} color="success"/>
                    </Grid>
                  </Grid>
                  ...
                  <Grid container alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress 
                      sx={{bgcolor:"#d0d0d0",borderRadius:4,height:6}}
                      variant="determinate" value={30} color="info"/>
                    </Grid>
                  </Grid>
        ...
        <div className="flex flex-wrap space-y-5 pl-16">
